...
var Dashboard = React.createClass({displayName: "Dashboard",
	...
	render: function() {
		...
		if (this.state.selectors.length < 4) { add_button = (React.createElement("button", {type: "button", className: "btn btn-default", onClick: this.addNewSelector}, "Add New Disease")); }
		if (this.state.selectors.length >= 3) { remove_button = (React.createElement("button", {type: "button", className: "btn btn-default", onClick: this.removeSelector}, "Remove Disease")); }

		return (
			React.createElement("div", {className: "dashboard container"}, 
				React.createElement("div", {className: "row", style: {'text-align': 'left', 'padding-left': 13}}, 
						React.createElement("h1", null, "NeedMD"), 
						add_button, " ",  remove_button, " ", React.createElement("button", {type: "button", className: "btn btn-default", onClick: this.computeScores}, "Compute Options!"), 
