...
var Dashboard = React.createClass({displayName: "Dashboard",
	...
	render: function() {
		...
		if (this.state.selectors.length < 4) {
			add_button = (React.createElement("button", {type: "button", className: "btn btn-default", onClick: this.addNewSelector}, "Add New Disease"))
		}
