	...
	render: function() {
		...
		if (!this.props.selected && input.length > 0) {
			diseases = this.props.diseases.filter(function(dis) {
				...
				return (React.createElement("tr", null, React.createElement("td", {onMouseDown: this.handleOnClick.bind(this,dis)},  dis )));
			}, this);
		};
		...
		return (
        	React.createElement("div", {className: "diseaseSelector col-md-4"}, 
                ...
                React.createElement("table", {className: "table table-hover table-striped"},  diseases )
            )
		);
	}
});
