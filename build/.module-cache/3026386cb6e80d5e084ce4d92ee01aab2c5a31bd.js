...
var Dashboard = React.createClass({displayName: "Dashboard",
	...
	render: function() {
		...
		if (this.state.selectors.length > 1) { remove_button = (React.createElement("button", {type: "button", className: "btn btn-default", onClick: this.removeSelector}, "Remove Disease")); }
