	...
	render: function() {
		...
		return (
        	React.createElement("div", {className: "diseaseSelector col-md-4"}, 
                React.createElement("input", {className: this.props.name, type: "text", value: this.state.input, onBlur: this.handleOutFocus, onChange: this.handleOnChange, placeholder: "Type here"}), 
