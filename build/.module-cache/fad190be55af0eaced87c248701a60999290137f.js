	...
	render: function() {
		...
		if (!this.props.selected && input.length > 0) {
			diseases = this.props.diseases.filter(function(dis) {
				...
				return (React.createElement("li", {className: "col-md-4", onMouseDown: this.handleOnClick.bind(this,dis)},  dis ));
			}, this);
		};

		return (
        	React.createElement("div", {className: "diseaseSelector col-md-4 col-centered"}, 
                ...
                React.createElement("ul", {className: "col-md-4"},  diseases )
            )
		);
	}
});
...
var Dashboard = React.createClass({displayName: "Dashboard",
	...
	computeScores: function() {
		...
		for (i in curr_selectors) {
			console.log(curr_selectors[i].input);
		}
	},
	...
	render: function() {
		...
		if (this.state.selectors.length == 2) {
			...
			button = (React.createElement("button", {type: "button", className: "btn btn-default", onClick: this.removeSelector}, "Remove Disease"))
		}
			...
			React.createElement("div", {className: "dashboard container"}, 
				React.createElement("div", {className: "row row-centered"}, 
					React.createElement("h1", null, "NeedMD"), 
					 button, " ", React.createElement("button", {type: "button", className: "btn btn-default", onClick: this.computeScores}, "Compute Options!"), 
