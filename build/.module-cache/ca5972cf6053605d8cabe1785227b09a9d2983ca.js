			...
			React.createElement("div", {className: "dashboard container"}, 
				React.createElement("div", {className: "row"}, 
					React.createElement("h1", null, "NeedMD"), 
					 button, React.createElement("div", {className: "col-xs-1"}), React.createElement("button", {type: "button", className: "btn btn-default", onClick: this.computeScores}, "Compute Options!"), 
